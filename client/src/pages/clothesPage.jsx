    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                ...
                className="group p-3 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 hover:rotate-3"
              >
              ...
              <div>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex items-center gap-1 px-2 py-1 mt-2 mx-10 bg-gradient-to-r from-emerald-100 to-green-100 rounded-full">
                    ...
                    <span className="text-emerald-700 text-xs font-semibold">Trending</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-2">
                <button
                  ...
                  className={`p-2 rounded-xl transition-all ${viewMode === "grid" ? "bg-indigo-100 text-indigo-600" : "text-gray-500 hover:bg-gray-100"}`}
                >
                  <Layers className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode("list")}
                  className={`p-2 rounded-xl transition-all ${viewMode === "list" ? "bg-indigo-100 text-indigo-600" : "text-gray-500 hover:bg-gray-100"}`}
                >
      ...
      {!selectedItem ? (
        <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
          ...
          <div className={`bg-white/60 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 mb-10 transition-all duration-500 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            ...
            <div className="flex items-center justify-between pt-6 mt-6 border-t border-indigo-200/30">
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-gray-700">Secure Shopping</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            {filteredClothes.map((item, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  {/* Badge */}
                  {item.badge && (
                    <div className={`absolute top-4 left-4 px-4 py-2 text-xs font-black text-white rounded-2xl shadow-2xl ${getBadgeColor(item.badge)} animate-pulse`}>
                      {item.badge}
                    </div>
                  )}
                  ...
                  >
                    <Heart className={`w-5 h-5 transition-colors ${favorites.has(item.id) ? 'fill-rose-500 text-rose-500' : 'text-indigo-600 group-hover/heart:text-rose-500'}`} />
                  </button>
                  ...
                  <button
                    ...
                    className={`absolute bottom-4 right-4 p-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl shadow-xl transform transition-all duration-300 ${
                      hoveredCard === item.id ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                    } hover:scale-110`}
                  >
                    <ShoppingCart className="w-5 h-5" />
                  </button>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-indigo-600 font-semibold">Quick View</span>
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 p-10">
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                  ...
                  {selectedItem.badge && (
                    <div className={`absolute top-6 left-6 px-6 py-3 text-sm font-black text-white rounded-2xl shadow-2xl ${getBadgeColor(selectedItem.badge)} animate-pulse`}>
                      {selectedItem.badge}
                    </div>
                  )}
                ...
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center bg-gradient-to-r from-amber-100 to-orange-100 px-4 py-2 rounded-2xl shadow-lg">
                      ...
                      <span className="text-xl font-black text-amber-700 ml-2">{selectedItem.rating}</span>
                      <span className="text-amber-600/80 ml-1 font-semibold">({selectedItem.reviews} reviews)</span>
                    </div>
                    ...
                    >
                      <Heart className={`w-6 h-6 ${favorites.has(selectedItem.id) ? 'fill-rose-500 text-rose-500' : 'text-rose-400 group-hover:text-rose-500'}`}/>
                    </button>
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">{selectedItem.description}</p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    <button 
                      ...
                      disabled={!selectedSize || !selectedColor || !selectedItem.inStock || isLoading}
                    ...
                    <div className="bg-gradient-to-r from-rose-50 to-red-50 border-2 border-rose-200 rounded-2xl p-4 animate-pulse">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-rose-700 font-bold">
                          Please select {!selectedSize && "size"} {!selectedSize && !selectedColor && "and"} {!selectedColor && "color"} to add to cart
                        </p>
                      </div>
                    </div>
                  )}
      ...
      <div className="fixed bottom-8 left-8 z-40">
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-white/50">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-700">{filteredClothes.filter(item => item.inStock).length} items available</span>
          </div>
        </div>
      </div>
    </div>

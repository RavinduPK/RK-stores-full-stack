...
function KitchenPage() {
          ...
          <div className="mt-10 max-w-3xl mx-auto">
            <div className="group relative">
              ...
              <div className="relative flex items-center gap-3 bg-white/80 backdrop-blur-xl rounded-3xl p-3 shadow-2xl border border-white/60">
                ...
                />
                <button className="px-8 py-3 rounded-2xl font-semibold bg-gradient-to-r from-orange-600 to-rose-600 text-white shadow-lg hover:scale-105 transition-all">
                  Search
                </button>
              </div>
            </div>
  ...
  if (page === "details" && selectedItem) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 p-10">
        <button
          onClick={handleBack}
          className="flex items-center gap-2 mb-8 px-5 py-2 rounded-full bg-gradient-to-r from-orange-600 to-rose-600 text-white shadow-lg hover:scale-105 transition-all"
        >
        ...
        <div className="grid md:grid-cols-2 gap-10 bg-white/80 rounded-3xl shadow-xl border border-white/60 p-6 backdrop-blur-xl">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-8">
              <span className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-rose-600">
                {selectedItem.price}
              </span>
            </div>
            ...
            <button
              ...
              className="px-8 py-4 rounded-2xl font-semibold bg-gradient-to-r from-orange-600 to-rose-600 text-white shadow-lg hover:scale-105 transition-all"
            >
              Add to Cart
            </button>
            ...
            <div className="mt-10 flex gap-6">
              ...
              <div className="flex items-center gap-2 bg-rose-100 p-4 rounded-xl shadow-md">
                <Truck className="w-6 h-6 text-rose-700" />

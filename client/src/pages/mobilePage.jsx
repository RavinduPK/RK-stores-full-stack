...
import { ArrowLeft, Search, ShoppingCart, Heart, Star, Zap, Smartphone } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 relative overflow-hidden">
      ...
      <nav className="relative z-20 backdrop-blur-xl bg-white/40 border-b border-white/60 shadow-lg sticky top-0">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            ...
            className="group flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
      ...
      <section className="relative z-10 text-center pt-16 pb-12 px-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 border border-indigo-200 mb-6 animate-bounce">
          ...
          <span className="text-sm font-semibold text-indigo-700">Lightning deals: Up to 30% off flagship phones!</span>
        </div>
        ...
        <div className="mt-10 max-w-3xl mx-auto">
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
            <div className="relative flex items-center gap-3 bg-white/80 backdrop-blur-xl rounded-3xl p-3 shadow-2xl border border-white/60">
              ...
              />
              <button className="px-8 py-3 rounded-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Search
              </button>
            </div>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-12">
            ...
            >
              ...
              {item.badge && (
                <div className={`absolute top-4 left-4 z-10 px-4 py-1.5 rounded-full text-white text-xs font-bold shadow-lg ${
                  ...
                  {item.badge === "Hot Deal" && <Zap className="w-3 h-3 inline mr-1" />}
                  {item.badge === "Premium" && <Smartphone className="w-3 h-3 inline mr-1" />}
                  {item.badge}
                </div>
              )}
              ...
              <div className="p-6">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-1 group-hover:text-indigo-600 transition-colors">
                  {item.name}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-3 rounded-xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2">
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <div className="absolute -inset-1 bg-gradient-to-r from-indigo-600/20 via-purple-600/20 to-blue-600/20 rounded-3xl blur-xl"></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 text-center">
          <button className="group px-10 py-4 rounded-2xl font-semibold bg-white/80 backdrop-blur-sm border-2 border-slate-200 hover:border-indigo-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <span className="text-slate-700 group-hover:text-indigo-600 transition-colors">
              Explore more tech products
            </span>
          </button>
        </div>
      </section>
      ...
      <footer className="relative z-10 mt-20 py-12 border-t border-white/60 backdrop-blur-sm bg-white/40">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">
            Premium smartphones and accessories at your fingertips
          </p>
        </div>
      </footer>

...
import { ArrowLeft, Search, ShoppingCart, Heart, Star, Flame, TrendingUp, Zap } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50 relative overflow-hidden">
      ...
      <nav className="relative z-20 backdrop-blur-xl bg-white/40 border-b border-white/60 shadow-lg sticky top-0">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            ...
            className="group flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-rose-600 to-orange-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
      ...
      <section className="relative z-10 text-center pt-16 pb-12 px-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-rose-100 to-orange-100 border border-rose-200 mb-6 animate-bounce">
          <Flame className="w-4 h-4 text-rose-600" />
          <span className="text-sm font-semibold text-rose-700">Hot Deals: Fresh food delivered daily!</span>
        </div>

        <h1 className="text-6xl md:text-7xl font-black tracking-tight mb-4">
          <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-rose-600 via-orange-600 to-amber-600 animate-gradient">
            Delicious Foods
          </span>
        </h1>
        ...
        <div className="mt-10 max-w-3xl mx-auto">
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-rose-600 via-orange-600 to-amber-600 rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
            <div className="relative flex items-center gap-3 bg-white/80 backdrop-blur-xl rounded-3xl p-3 shadow-2xl border border-white/60">
              ...
              />
              <button className="px-8 py-3 rounded-2xl font-semibold bg-gradient-to-r from-rose-600 to-orange-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Search
              </button>
            </div>
          </div>
          ...
          {filters.map((f) => (
            <button
              ...
              className={`px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 ${
                selectedFilter === f
                  ? "bg-gradient-to-r from-rose-600 to-orange-600 text-white shadow-lg scale-105"
            ...
            >
              ...
              {item.badge && (
                <div className={`absolute top-4 left-4 z-10 px-4 py-1.5 rounded-full text-white text-xs font-bold shadow-lg ${
                  ...
                  {item.badge === "Premium" && <Flame className="w-3 h-3 inline mr-1" />}
                  {item.badge}
                </div>
              )}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-3 rounded-xl font-semibold bg-gradient-to-r from-rose-600 to-orange-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2">
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <div className="absolute -inset-1 bg-gradient-to-r from-rose-600/20 via-orange-600/20 to-amber-600/20 rounded-3xl blur-xl"></div>
              </div>
            </div>
          ))}
        </div>
      ...
      <footer className="relative z-10 mt-20 py-12 border-t border-white/60 backdrop-blur-sm bg-white/40">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">
            Your destination for delicious food and beverages
          </p>
        </div>
      </footer>

...
import { ArrowLeft, Search, ShoppingCart, Heart, Star, Sparkles } from "lucide-react"
...
const flowers = [
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 89,
    img: "https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=1200&auto=format&fit=crop",
  },
  {
    name: "Orchid Plant",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 203,
    img: "https://images.unsplash.com/photo-1597848212624-e530bb7a6c87?q=80&w=1200&auto=format&fit=crop",
  },
  {
    name: "Lavender Plant",
    ...
    rating: 4.5,
    reviews: 67,
    img: "https://images.unsplash.com/photo-1611419010196-754f7ab46c3e?q=80&w=1200&auto=format&fit=crop",
  },
  {
    name: "Mixed Flowers",
    ...
    rating: 4.8,
    reviews: 178,
    img: "https://images.unsplash.com/photo-1487070183336-b863922373d4?q=80&w=1200&auto=format&fit=crop",
    badge: "New"
  },
]
...
function FlowersPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-fuchsia-50 to-rose-50 relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-purple-300/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-pink-300/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-700"></div>
        <div className="absolute -bottom-32 left-1/3 w-96 h-96 bg-rose-300/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <section className="relative z-10 text-center pt-16 pb-12 px-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-violet-100 to-fuchsia-100 border border-violet-200 mb-6 animate-bounce">
          ...
          <span className="text-sm font-semibold text-violet-700">Free delivery on orders over $50</span>
        </div>

        <h1 className="text-6xl md:text-7xl font-black tracking-tight mb-4">
          <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-fuchsia-600 to-rose-600 animate-gradient">
            Flowers & Bouquets
          </span>
        </h1>
        <p className="text-xl md:text-2xl text-slate-600 font-light max-w-2xl mx-auto">
          Curated blooms to brighten every moment 🌸
        </p>

        {/* Modern Search Bar */}
        <div className="mt-10 max-w-3xl mx-auto">
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-rose-600 rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
            <div className="relative flex items-center gap-3 bg-white/80 backdrop-blur-xl rounded-3xl p-3 shadow-2xl border border-white/60">
              ...
              <input
                type="text"
                placeholder="Search for roses, tulips, orchids..."
                value={searchQuery}
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {flowers.map((item, i) => (
            ...
            >
              {/* Badge */}
              {item.badge && (
                <div className="absolute top-4 left-4 z-10 px-4 py-1.5 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white text-xs font-bold shadow-lg">
                  {item.badge}
                </div>
              )}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-3 rounded-xl font-semibold bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2">
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <div className="absolute -inset-1 bg-gradient-to-r from-violet-600/20 via-fuchsia-600/20 to-rose-600/20 rounded-3xl blur-xl"></div>
              </div>
            </div>
          ))}
        </div>
      ...
      <footer className="relative z-10 mt-20 py-12 border-t border-white/60 backdrop-blur-sm bg-white/40">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">
            Making the world more beautiful, one bouquet at a time
          </p>
        </div>
      </footer>
